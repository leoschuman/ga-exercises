...
require 'lib/app_utilities_solution'

puts AppUtilitiesSolution::HOME_IP
puts AppUtilitiesSolution::APP_NAME

include AppUtilitiesSolution
sentence = "What's the blanking problem with my code?!"
puts AppUtilitiesSolution.sentence_cleaner(sentence, "blanking")